...
namespace AWSSDK.Examples
{
    public class S3Example : MonoBehaviour
    {
        ...
        public Button CreateObjectButton = null;
        ...
        void Start()
        {
            ...
            CreateObjectButton.onClick.AddListener(() => { CreateBucket(); });
        ...
        {
            Client.PutBucketAsync("magicmirrorunity", (callback) =>
            {
                ResultText.text += "\n";
        ...
        public void GetObjects()
        {
            ...
            Client.ListObjectsAsync(request, (responseObject) =>
            {
                ...
                if (responseObject.Exception == null)
                {
                    ...
                    {
                        Debug.Log("File Key: "+o.Key+" bucket name: "+o.BucketName);
