...
//	public int playerIndex = 0;
	...
	[Tooltip("GUI-texture Obejct used to display the tracked users on scene background.")]
...
//	private Vector2 posLeft, posTop, posRight, posBottom;
	...
	void Start () 
	{
		...
		backgroundImageTexture = backgroundImage.GetComponent<Texture>();
	...
	void Update () 
	{
		if (manager && manager.IsInitialized ()) 
		{
			...
			{
				backgroundImageTexture = depthImage;
			}
		}
	}
