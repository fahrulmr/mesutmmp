...
public class KinectManager : MonoBehaviour 
{
	...
	public RawImage DisplayNoBackgroundImage;
...
//		}
	...
	{
		//<custom
//		sensorAngle = PanelManager.Instance.GetPanel<SettingsPanelBehaviour>().Settings.SensorAngle;
//		sensorHeight = PanelManager.Instance.GetPanel<SettingsPanelBehaviour>().Settings.SensorHeight;
		//</custom
		try
		{
...
////				//DepthImage.texture = GetUsersLblTex();
////
////	        }
////			else 
...
//					//DisplayImage.transform.localScale = Vector3.one * PanelManager.Instance.GetPanel<SettingsPanelBehaviour> ().Settings.DisplayScale;
////					DisplayImage.texture = sensorData.colorImageTexture;
//
//
//					DisplayImage.texture = GetUsersClrTex();
//
//					//тут попередня версія removebackground
//
////					if (DepthImage != null) {
////						DepthImage.texture = GetUsersLblTex ();
////						if (!Settings.Instance.ShowBackground)
////						{
////							DisplayNoBackgroundImage.texture = GetUsersLblTex();
////						}
////					}
////					if (DepthImage != null && Settings.Instance.ShowBackground) {
//////						if (Settings.Instance.ShowBackground)
//////						{
////							DepthImage.texture = GetUsersLblTex();
//////						}
